...
public class ControladorReserva {
    ...
    public ControladorReserva(ControladorHabitacion roomManager) {
        this.controladorHabitacion = roomManager;
        reservas = cargarReservas();
    }

    public void agregarReserva(Reserva reserva) {
        reservas.add(reserva);
        controladorHabitacion.actualizarDisponibilidad(reserva.getIdHabitacion(), true);
        guardarReservas();
    }
    ...
    public void cancelarReserva(String emailUsuario, String idHabitacion) {
        for (Reserva reserva : reservas) {
            if (reserva.getEmailUsuario().equals(emailUsuario) && reserva.getIdHabitacion().equals(idHabitacion)) {
                ...
                controladorHabitacion.actualizarDisponibilidad(idHabitacion, false);
                break;
            }
        }
        guardarReservas();
